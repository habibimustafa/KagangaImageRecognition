...
/**
 * @author Felipe Custódio, Gabriel Scalici
 * Source: https://github.com/felipecustodio/chain-codes
 * 
 * Modified by Habibi Mustafa
 */
public class Chain {
    ...
    public Chain(BufferedImage image) throws IOException {
    ...
    public int[] borderNeighbors(int i, int j) {
    	...
    	if (borderPixel(i, j+1) && !flag && !flag && visited[i][j+1] == 0) {
    		j = j + 1;
    		System.out.print("0 ");
                chainResult[chainResult.length+1] = 0;
    		perimeter += 1;
    		flag = true;
    		index[0] = i;
    		index[1] = j;
    	...
    	if (borderPixel(i+1, j+1) && !flag && visited[i+1][j+1] == 0) {
    		...
    		j = j + 1;
    		System.out.print("1 ");
                chainResult[chainResult.length+1] = 1;
    	...
    	if (borderPixel(i+1, j) && !flag && visited[i+1][j] == 0) {
    		i = i + 1;
    		System.out.print("2 ");
                chainResult[chainResult.length+1] = 2;
    		perimeter += 1;
    		flag = true;
    		index[0] = i;
    		index[1] = j;
    	...
    	if (borderPixel(i+1, j-1) && !flag && visited[i+1][j-1] == 0) {
    		...
    		j = j - 1;
    		System.out.print("3 ");
                chainResult[chainResult.length+1] = 3;
    		perimeter += Math.sqrt(2);
    		flag = true;
    		index[0] = i;
    		index[1] = j;
    	...
    	if (borderPixel(i, j-1) && !flag && visited[i][j-1] == 0) {
    		j = j - 1;
    		System.out.print("4 ");
                chainResult[chainResult.length+1] = 4;
    		perimeter += 1;
    		flag = true;
    		index[0] = i;
    		index[1] = j;
    	...
    	if (borderPixel(i-1, j-1) && !flag && visited[i-1][j-1] == 0) {
    		...
    		j = j - 1;
    		System.out.print("5 ");
                chainResult[chainResult.length+1] = 5;
    		perimeter += Math.sqrt(2);
    		flag = true;
    		index[0] = i;
    		index[1] = j;
    	...
    	if (borderPixel(i-1, j) && !flag && visited[i-1][j] == 0) {
    		i = i - 1;
    		System.out.print("6 ");
                chainResult[chainResult.length+1] = 6;
    		perimeter += 1;
    		flag = true;
    		index[0] = i;
    		index[1] = j;
    	...
    	if (borderPixel(i-1, j+1) && !flag && visited[i-1][j+1] == 0) {
    		...
    		j = j + 1;
    		System.out.print("7 ");
                chainResult[chainResult.length+1] = 7;
    		perimeter += Math.sqrt(2);
    		flag = true;
    		index[0] = i;
    		index[1] = j;
    ...
    public int[] chainCodes(int i, int j) {
